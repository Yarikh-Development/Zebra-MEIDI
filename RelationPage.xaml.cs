...
namespace demo
{
	...
	public partial class RelationPage : Page
	{
			...
			try
			{
				...
				while ((line = streamReader.ReadLine()) != null)
				{
					if (line != "")
					{
						...
						Relation_ListView.Items.Add(new { number = data[0], XML = data[1], ZPL = data[2], printer = data[3] });
					}
				}
		...
		private void ChangeRelationRecord(object sender, RoutedEventArgs e)
		{
			...
			string[] data = lines[Relation_ListView.SelectedIndex].Split(new char[] { ';' });
			Relation_ListView.Items[Relation_ListView.SelectedIndex] = new { number = data[0], XML = data[1], ZPL = data[2], printer = data[3] };
		}
